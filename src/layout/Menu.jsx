...
import Close from '../assets/common/menu/close.svg';
import Airpalne from '../assets/common/menu/airplane.svg'
import Insta from '../assets/common/menu/insta.svg'
import Kakao from '../assets/common/menu/kakao.svg'
  ...
  return (
    <div className='modal-container'>
      <div className='modal-body' onClick={(e)=>{e.stopPropagation();}}>
        <img className='modal-close'src={Close} onClick={()=>setIsOpen(!isOpen)}></img>
        <div className='modal-text'>
          <div className='modal-text1'>여러분의 탑승을</div>
          <div className='modal-text2'>진심으로 환영합니다.</div>
          <div className='modal-text3'>
            <img src={Airpalne}className='modal-text3-airplane'></img>
            <div className='modal-text3-detail1'>SMU</div>
            <div className='modal-text3-detal2'>
            ...
            <div className='modal-text3-detail3'>BISANG</div>
        ...
        <div className='modal-items'>
          {items.map((item)=>{
            return(
            <div key={item.id} className='modal-item' onClick={()=>{navigate(item.url)}}>
              {item.text}
              <div className='modal-item-direction'>{'>'}</div>
            </div>)

          })}
        </div>
        <div className='modal-bottom'>
          <div className='modal-bottom-festival'>
            <div className='modal-festival-title'>축제 문의</div>
            <div className='modal-festival-url'>
              <a style={{ marginRight: '30px' }}href={studentInsta} className='modal-a'>
                <div style={{ marginRight: '10px' }}><img src={Insta}></img></div>
                <div>
                  <div className='modal-font'>총학생회</div>
                  <div className='modal-font'>인스타그램</div>
                </div>
              </a>
              <a href={studentKakao} className='modal-a'>
                <div style={{ marginRight: '10px' }}><img src={Kakao}></img></div>
                <div>
                  <div className='modal-font'>총학생회</div>
                  <div className='modal-font'>카카오톡 오픈채팅</div>
                </div>
              </a>
            </div>
          </div>
          <div className='modal-bottm-site'>
            <div className='modal-site-title' style={{ marginBottom: '10px' }}>사이트 문의</div>
            <a href={developInsta} className='modal-site-url'>
              <div style={{ marginRight: '10px' }}><img style={{width:24,height:24}}src={Insta}></img></div>
              <div>
                <div className='modal-font'>멋쟁이 사자처럼</div>
                <div className='modal-font'>인스타그램</div>
              </div>
            </a>
          </div>
